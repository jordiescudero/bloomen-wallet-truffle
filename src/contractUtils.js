...
var fs = require('fs');
var contractJSON = JSON.parse(fs.readFileSync('./build/contracts/SimpleStorage.json', 'utf8'));
...
function set(value){
        contractInstance.methods.set(value).send( transactionObject).then(checkTransaction);
}
